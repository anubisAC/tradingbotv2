...
class RegimeDetectionValidator:
    ...
    def validate_regime_classification(
        ...
        for regime in ["BULL", "NEUTRAL", "BEAR"]:
            ...
            # Extract explicitly aligned dates to prevent pandas IndexingError
            regime_dates = regime_mask[regime_mask].index
            valid_dates = regime_dates.intersection(prices.index)
            regime_returns = prices.pct_change().loc[valid_dates]
